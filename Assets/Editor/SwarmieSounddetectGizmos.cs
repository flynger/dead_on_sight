...
{
    [CustomEditor(typeof(SwarmieSoundDetectAI)), CanEditMultipleObjects]
    public class SwarmieSounddetectGizmos : FieldOfVIewGizmos
    {
        private void OnSceneGUI()
        {
            SwarmieSoundDetectAI fOV = (SwarmieSoundDetectAI)target;
